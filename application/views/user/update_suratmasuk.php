<div class="container-fluid">
	...
	<span aria-hidden="true">&times;</span></button></div>';
		...
		<span aria-hidden="true">&times;</span></button></div>';
			...
			<?php echo form_open_multipart('user/proses_updatedatamasuk/' . $surat_masuk['no_urut']); ?>
			...
			<input type="text" class="form-control" placeholder="masukan isi ringkasan" name="isi_ringkasan">
				...
				<div class="form-group">
					...
					<a href="<?= base_url('user/disposisi/' . $surat_masuk['no_urut']) ?>" class="text-white btn btn-primary">DISPOSISI</a>
				</div>
