		...
		<span aria-hidden="true">&times;</span></button></div>';
            ...
            <form method="post" action="">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?= $surat_masuk['kepada'] ?>"
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <button type="button" class="btn btn-primary form-control mb-3" data-toggle="modal"
                            data-target=".bd-example-modal-lg">Scan Dokumen</button>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <button type="button" class="btn btn-primary form-control mb-3" data-toggle="modal"
                            data-target="#modal_klasifikasi">Masukkan Keterangan Klasifikasi</button>
                    </div>
                            ...
                            <div class="modal-body">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4 d-none" id="subjek">
                                        ...
                                        <input type="text" class="form-control"
                                            value="<?= $surat_masuk['pokok_soal'] ?>" placeholder="Masukan Pokok Soal"
                                            name="pokok_soal">
                                    </div>
                                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="container mt-3 mx-auto">
                                ...
                                <div class="flash"></div>
                                <a download class="btn text-white btn-md mt-2 btn-block btn-info" id="download-photo"><i
                                        class="fa fa-download"></i> Download Picture</a>
                            </div>
                        </div>
                        <div class="modal-footer">
