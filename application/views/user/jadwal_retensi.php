...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      ...
      <a href="<?php echo base_url('user/form_jadwalretensi') ?>" class="btn btn-primary btn-sm float-left">Tambah Jadwal Retensi</a>
    </div>
    <div class="card-body">
            ...
            <?php foreach ($retensi as $dt) : ?>
              <tr>
                ...
                <td>
                  ...
                  <a href="<?php echo base_url() ?>user/hapus_dataretensi/<?php echo $dt['no_urut']; ?>" class="badge badge-danger"> Hapus </a>
                </td>
              </tr>
