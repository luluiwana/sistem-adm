                    ...
                    <table class="table table-hover" id="jadwal_rapat" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr data-toggle="collapse" data-target="#collapseOne<?php echo $dt->no_urut; ?>">
                                ...
                                <td>
                                    <a href="<?php echo base_url() ?>user/update_datakeluar/<?php echo $dt->no_urut; ?>"
                                        class="badge badge-primary"> Edit </a>
                                    <a href="<?php echo base_url() ?>user/hapus_datakeluar<?php echo $dt->no_urut; ?>"
                                        class="badge badge-danger"> Hapus </a>
                                </td>
                                <?php } else { ?>
                                <td>
                                    <a href="<?php echo base_url() ?>user/update_datamasuk/<?php echo $dt->no_urut; ?>"
                                        class="badge badge-primary"> Edit </a>
                                    <a href="<?php echo base_url() ?>user/hapus_datamasuk/<?php echo $dt->no_urut; ?>"
                                        class="badge badge-danger"> Hapus </a>
                                </td>
                                <?php } ?>
                            </tr>
