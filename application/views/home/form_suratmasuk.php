<div class="card border ">
    <div class="card-header bg-dark text-white">Tambah Surat Masuk</div>
    <div class="card-body">
        <?php
	...
	<span aria-hidden="true">&times;</span></button></div>';
		...
		?>
            <form method="post" action="<?= base_url('home/proses_tambahdatamasuk') ?>" id='sm'
                ...
                <div class="form-row">
                    <div class="form-group col-md-8">
                        ...
                        <input type="text" class="form-control" placeholder="Masukkan Keterangan Alamat" name="alamat"
                            required>
                    </div>
                    <div class="form-group col-md-4">
                        <label for="kota">Kota</label>
                        <input type="text" class="form-control" name="kota" placeholder="Masukkan Keterangan Kota"
                            required>
                    </div>
                </div>
                <div class="form-row ">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" name="indeks" placeholder="Masukkan Keterangan Indeks"
                            required>
                    </div>
                    <div class="form-group col-md-4">
                        <label for="exampleFormControlInput1">No Surat</label>
                        <input type="text" class="form-control" placeholder="Masukan Nomor Surat" name="no_surat"
                            required>
                    </div>
                    <div class="form-group col-md-4">
                        <label for="exampleFormControlInput1">Tanggal Surat</label>
                        <input type="date" class="form-control" placeholder="Masukan tanggal surat" name="tanggal_surat"
                            required>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="number" class="form-control" placeholder="Masukan Jumlah Lampiran" name="lampiran"
                            required>
                    </div>
                    <div class="form-group col-md-4">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <button type="button" class="btn btn-primary form-control mb-3 text-white" data-toggle="modal"
                            data-target="#scanner">Scan Dokumen</button>
                    </div>
                </div>
				...
				<div class="form-group col-md-4">
                    ...
                    <input type="date" class="form-control" placeholder="Masukan tanggal simpan" name="tanggal_simpan"
                        required>
                </div>
                    <div class="form-group col-md-4">
			...
			<input type="text" class="form-control" placeholder="masukan isi ringkasan" name="isi_ringkasan">
                ...
                <input type="hidden" name="hidee" id="hide" value="">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-5">
                                ...
                                <input type="date" class="form-control" placeholder="Masukan Tanggal Rapat"
                                    name="tgl_rapat" value="<?php print(date("Y-m-d")); ?>">
                            </div>
                ...
                <div class="form-group">
                    ...
                    <input class="btn btn-info" type="submit" value="SIMPAN" name="btn_1">
                    <input class="btn btn-info" type="submit" value="DISPOSISI" name="btn_1">
                </div>
            ...
            <!-- Modal -->
            <div id="scanner" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog"
                aria-labelledby="myLargeModalLabel" aria-hidden="true">
