                    ...
                    <?php foreach ($mhs as $row) : ?>
                        ...
                        <tr>
                            <td rowspan="3">
                                ...
                                <button type="button" class="btn btn-primary btn-sm mt-4" data-toggle="modal" data-target="#<?= $button ?>">Ubah Nilai</button>
                                                    ...
                                                    <table class="table table-borderless">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <input type="number" name="nilai" id="" placeholder="Masukkan Nilai" class="form-control" required>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Komentar</td>
                                                            <td>
                                                                <textarea name="komentar" id="" cols="30" rows="7" class="form-control"></textarea>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2">
                                                                <input type="submit" class="btn btn-primary form-control" value="Ubah Nilai">
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </form>
                                                ...
                                                <form action="<?= base_url('home/update_nilai/' . $row->id) ?>" method="post">
                                                    <table class="table table-borderless">
                                                        <tr>
                                                            <td>Nilai</td>
                                                            <td>
                                                                <input type="number" name="nilai" id="" value="<?= $row->nilai ?>" placeholder="Masukkan Nilai" class="form-control" required>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Komentar</td>
                                                            <td>
                                                                <textarea name="komentar" id="" cols="30" rows="7" class="form-control"><?= $row->komentar ?></textarea>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2">
