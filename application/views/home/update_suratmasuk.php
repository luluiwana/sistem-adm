                ...
                <form method="post" action="">
                    ...
                    <div class="form-row border">
                        ...
                        <div class=" form-group col-md-4">
                            ...
                            <button type="button" class="btn btn-success form-control mb-3" data-toggle="modal" data-target="#edit-scan">Scan Dokumen</button>
                        </div>
                        <div class="form-group col-md-2">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <button type="button" class="btn btn-primary form-control mb-3 text-white" data-toggle="modal" data-target="#modal_klasifikasi">Masukkan Keterangan
                                Klasifikasi</button>
                        </div>
			...
			<input type="text" class="form-control" placeholder="masukan isi ringkasan" name="isi_ringkasan">
				...
				<input type="file" class="form-control" placeholder="Masukan lampiran" name="userfile" size="20">
                    ...
                    <div class="form-group">
                        ...
                        <a href="<?= base_url('home/disposisi/' . $surat_masuk['no_urut']) ?>" class="text-white btn btn-primary">DISPOSISI</a>
                    </div>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="d-none" id='mod'>
                                        ...
                                        <div class="form-group" id='data_5'>
                                            ...
                                            <input type="text" class="form-control" placeholder="" value='<?= $surat_masuk['kode_5'] ?>' name="input_5">
                                        </div>
                ...
                <div id="edit-scan" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
