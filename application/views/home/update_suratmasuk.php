<div class="container-fluid">
	<div class="alert alert-success" role="alert">
		Masukkan Keterangan Detail dari Form Surat Masuk
	</div>
			...
			<form method="post" action="">
				...
				<div class="form-row">
					...
					<div class="form-group col-md-2">
						...
						<button name='save' value='upload' type="submit" class="btn btn-primary">Perbarui Dokumen</button>
					</div>

					<div class=" form-group col-md-3">
						<label for="exampleFormControlInput1">Scan Dokumen</label>
						<button type="button" class="btn btn-success form-control mb-3" data-toggle="modal" data-target=".bd-example-modal-lg">Scan Dokumen</button>
					</div>
								...
								<div class="form-row">
									<div class="form-group col-md-8">
										...
										<select class="form-control" id="kategori" name="kategori">
											<option value="<?= $surat_masuk['kategori'] ?>"><?= $surat_masuk['kategori'] ?></option>
