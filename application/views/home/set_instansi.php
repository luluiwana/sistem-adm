<div class="container-fluid">
	...
	<span aria-hidden="true">&times;</span></button></div>';
        ...
        <div class="row">
            <div class="col-md-10">
                <form action="<?= base_url('home/update_instansi'); ?>" method="post" enctype="multipart/form-data">

                    <div class="form-group row ml-1">
                        <a href="<?php echo base_url('home/form_suratmasuk') ?>" class="btn btn-primary btn-sm " data-toggle="modal" data-target=".bd-example-modal-lg">Edit Data Unit Pokok</a>
                    </div>
                    <div class="form-group row">
                        <label for="inputPassword" class="col-sm-2 col-form-label">HEADER 1</label>
                        <input type="text" name="h1" value="<?= $instansi['header_1'] ?>" class="col-sm-10 form-control">
                    </div>
                    <div class="form-group row">
                        <label for="inputPassword" class="col-sm-2 col-form-label">HEADER 2</label>
                        <input type="text" name="h2" value="<?= $instansi['header_2'] ?>" class=" col-sm-10 form-control">
                    </div>
                    <div class="form-group row">
                        <label for="inputPassword" class="col-sm-2 col-form-label">HEADER 3</label>
                        <input type="text" name="h3" value="<?= $instansi['header_3'] ?>" class=" col-sm-10 form-control">
                    </div>
                    <div class="form-group row">
                        <label for="inputPassword" class="col-sm-2 col-form-label">HEADER 4</label>
                        <input type="text" name="h4" value="<?= $instansi['header_4'] ?>" class=" col-sm-10 form-control">
                    </div>
                    <div class="form-group row">
                        <label for="inputPassword" class="col-sm-2 col-form-label">HEADER 5 </label>
                        <input type="text" name="h5" value="<?= $instansi['header_5'] ?>" class=" col-sm-10 form-control">
                    </div>

                    <div class="form-group row">
                        <label for="inputPassword" class="col-sm-2 col-form-label">Ketua Pimpinan </label>
                        <input type="text" name="h6" value="<?= $instansi['header_6'] ?>" class=" col-sm-10 form-control">
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="tab-content mt-4 mb-4" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                <form class="mb-4" action="<?= base_url('home/addUnit') ?>" method="POST">
                                ...
                                <form class="mb-2" action="<?= base_url('home/editUnit') ?>" method="POST">
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td><?= $data['id'] ?></td>
                                                        <td><?= $data['unit'] ?></td>
                                                        <td><a href="<?= base_url('home/deleteUnit/' . $data['id']) ?>" class="btn btn-danger btn-sm">Delete</a></td>
                                                    </tr>
                                            <?php
                                                }
                                            }
                            ...
                            <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                    <form class="mb-4" action="<?= base_url('home/addMasalah') ?>" method="POST">
                                        <div class="form-group form-inline">
                                    ...
                                    <form class="mb-2" action="<?= base_url('home/editMasalah') ?>" method="POST">
                                        <div class="form-inline form-group">
