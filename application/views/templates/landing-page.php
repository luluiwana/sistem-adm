  ...
  <![endif]-->
    ...
    <header class="header-area">
        ...
        <div id="home" class="header-hero bg_cover"
            style="background-image: url(assets/landing-page/images/banner-bg.svg)">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="header-hero-content text-center">
                            ...
                            <p class="text wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.8s">Universitas
                                Negeri Malang</p>
                            <a href="<?php echo base_url('auth/daftar') ?>" class="main-btn wow fadeInUp"
                                data-wow-duration="1.3s" data-wow-delay="1.1s">Daftar Sekarang</a>
                            <a href="<?php echo base_url('auth/login') ?>" class="main-btn wow fadeInUp"
                                data-wow-duration="1.3s" data-wow-delay="1.1s">Login</a>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-team text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        <div class="team-image">
                            <img src="<?=base_url('assets/landing-page/images/team-1.png')?>" alt="Team">
                            <div class="social">
                                <ul>
                ...
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-team text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="team-image">
                            <img src="<?=base_url('assets/landing-page/images/team-2.png')?>" alt="Team">
                            <div class="social">
                                <ul>
                                    <li><a href="#"><i class="lni-facebook-filled"></i></a></li>
                                    <li><a href="#"><i class="lni-twitter-filled"></i></a></li>
                ...
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-team text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                        <div class="team-image">
                            <img src="<?=base_url('assets/landing-page/images/team-3.png')?>" alt="Team">
                            <div class="social">
                                <ul>
                                    <li><a href="#"><i class="lni-facebook-filled"></i></a></li>
                                    <li><a href="#"><i class="lni-twitter-filled"></i></a></li>
                    ...
                    <div class="single-testimonial">
                        ...
                        <div class="testimonial-author d-flex align-items-center">
                            <div class="author-image">
                                <img class="shape"
                                    src="<?=base_url('assets/landing-page/images/textimonial-shape.svg')?>" alt="shape">
                                <img class="author" src="<?=base_url('assets/landing-page/images/author-1.png')?>"
                                    alt="author">
                            </div>
                    ...
                    <div class="single-testimonial">
                        ...
                        <div class="testimonial-author d-flex align-items-center">
                            <div class="author-image">
                                <img class="shape"
                                    src="<?=base_url('assets/landing-page/images/textimonial-shape.svg')?>" alt="shape">
                                <img class="author" src="<?=base_url('assets/landing-page/images/author-2.png')?>"
                                    alt="author">
                            </div>
                            <div class="author-content media-body">
                    ...
                    <div class="single-testimonial">
                        ...
                        <div class="testimonial-author d-flex align-items-center">
                            <div class="author-image">
                                <img class="shape"
                                    src="<?=base_url('assets/landing-page/images/textimonial-shape.svg')?>" alt="shape">
                                <img class="author" src="<?=base_url('assets/landing-page/images/author-3.png')?>"
                                    alt="author">
                            </div>
                            <div class="author-content media-body">
