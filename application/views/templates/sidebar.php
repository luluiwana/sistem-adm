    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('home') ?>">
        <div class="sidebar-brand-icon">
          <img src="<?php echo base_url('files/img/'); ?>logo-um.png" alt="logo um" class="float-left " width="80px"></img>
        </div>
        <div class="sidebar-brand-text mr-4">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('home/penyusutan') ?>">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('home/buku_agenda') ?>">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('home/edit_profil') ?>">
